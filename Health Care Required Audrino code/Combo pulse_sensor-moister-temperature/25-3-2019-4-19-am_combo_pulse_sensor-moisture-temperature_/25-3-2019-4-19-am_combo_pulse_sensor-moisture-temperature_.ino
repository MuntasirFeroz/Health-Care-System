...
void setup() {
   ...
   //Serial.begin(9600);
   Serial.begin(128000); //for plx
   Serial.println("CLEARDATA");
   Serial.println("LABEL,MOISTURE,TEMPERATURE,PULSE");
   //=========temp==========
   temp.begin(); // Initialize I2C library and the MLX90614
   temp.setUnit(TEMP_C); // Set units to Farenheit (alternatively TEMP_C or TEMP_K or TEMP_F)
  //=========PULSE==============
...
void loop() {
  ...
  Serial.print("DATA,MOISTURE,TEMPERATURE,PULSE,");
   //==================MOISTURE========================
  //int moisture_data=read_moisture();//reads moisture data from moisture sensor
  moisture_output_value= analogRead(moisture_sensor_pin);
   moisture_output_value = map(moisture_output_value,550,0,0,100);
   Serial.print(String(moisture_output_value));
   Serial.print(",");
    //delay(2000);
  ...
  //    Serial.println("Ambient: " + String(ambientT));
    //Serial.print("Object: " + String(objectT));
